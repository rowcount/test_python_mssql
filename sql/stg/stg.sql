...
CREATE DATABASE [stg]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'stg', FILENAME = N'/var/opt/mssql/data/stg.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'stg_log', FILENAME = N'/var/opt/mssql/data/stg_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
