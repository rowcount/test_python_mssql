...
CREATE DATABASE [dm]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'dm', FILENAME = N'/var/opt/mssql/data/dm.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'dm_log', FILENAME = N'/var/opt/mssql/data/dm_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [dm] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
